...
#define ELH_PARAMS_ADAPTIVE { 0, 1, 1, 0 }     /* fully adaptive k (elastic hashing) */
#define ELH_PARAMS_ADAPTIVE { 0, 1, 1, 0 }     /* fully adaptive k (elastic hashing) */
...
/* ── Streaming API ─────────────────────────────────────────
 * Compresses data incrementally. Each chunk is compressed
 * against the full history of all previous chunks.
 * Matches span chunk boundaries up to 65535 bytes back.
 * Ideal for KV cache compression, log streaming, incremental
 * backup of append-only data structures.
 * ────────────────────────────────────────────────────────── */
